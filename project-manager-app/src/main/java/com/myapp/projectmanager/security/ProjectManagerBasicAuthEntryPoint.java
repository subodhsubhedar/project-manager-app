...
public class ProjectManagerBasicAuthEntryPoint extends BasicAuthenticationEntryPoint {

	private static final Logger logger = LoggerFactory.getLogger(ProjectManagerBasicAuthEntryPoint.class);
